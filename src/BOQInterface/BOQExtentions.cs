...
namespace BOQInterface
{
    public static class BOQExtentions
    {
        ...
        //public static double GetElementLength(ref FEMModel fem,int elemID)
        //{
        //    FEMElement elem = fem.ElementList.Find(e => e.ID == elemID);
        //    FEMNode nodeA = fem.NodeList.Find(n => n.ID == elem.Ni);
        //    FEMNode nodeB = fem.NodeList.Find(n => n.ID == elem.Nj);
        ...
        public static void CastBOQTable(this FEMModel theFEM, ref BOQTable outTable)
        {
            ...
            #region 立柱
            foreach (var item in theFEM.RelatedArchBridge.ColumnList)
            {
                ...
                outTable.AddItem(eMemberType.ColumnMain, eMaterial.C50SCC, 4, (item.Z1 - item.Z0) * footAc, (item.Z1 - item.Z0));
        ...
        //            {
        //                if (item.ElemType==eMemberType.SubWeb || 
        //                    item.ElemType == eMemberType.TriWeb|| 
        //                    item.ElemType == eMemberType.MainWeb)
        //                {
        ...
        //                if (H<11.0)
        //                {
        //                    outTable.AddItem(eMemberType.WindBracing, eMaterial.Q345D_T, 8, A1 * P1.DistanceTo(P2) * 7.85);
        //                    outTable.AddItem(eMemberType.WindBracing, eMaterial.Q345D_T, 2, A1 * P2.DistanceTo(P4) * 7.85);
        //                }
        //                else if (H<13.0)
        //                {
        //                    outTable.AddItem(eMemberType.WindBracing, eMaterial.Q345D_T, 8, A1 * P1.DistanceTo(P2+ (P12-P2).ScaleBy(0.33333333333333)) * 7.85);
        //                    outTable.AddItem(eMemberType.WindBracing, eMaterial.Q345D_T, 4, A1 * P2.DistanceTo(P4) * 7.85);
        //                } 
        //                else
        //                {
        //                    outTable.AddItem(eMemberType.WindBracing, eMaterial.Q345D_T, 16, A1 * P1.DistanceTo(P2 + (P12 - P2).ScaleBy(0.5)) * 7.85);
        //                    outTable.AddItem(eMemberType.WindBracing, eMaterial.Q345D_T, 4, A1 * P2.DistanceTo(P4) * 7.85);
        ...
        //                    ;
        //                    outTable.AddItem(eMemberType.WindBracing, eMaterial.Q345D_T, 2, A2 * H * 7.85);
        //                    if (H<13.0)
        //                    {
        //                        outTable.AddItem(eMemberType.WindBracing, eMaterial.Q345D_T, 2, A2 * Math.Sqrt(H*H+theArch.WidthInside*theArch.WidthInside)* 7.85);
        //                    }
        //                    else
        //                    {
        //                        outTable.AddItem(eMemberType.WindBracing, eMaterial.Q345D_T, 4, A2 * Math.Sqrt(H * H*0.25 + theArch.WidthInside * theArch.WidthInside) * 7.85);
        //                    }
        //                }
        ...
        //                        Debug.WriteLine(lsp);
        //#endif
        //                        outTable.AddItem(eMemberType.WindBrace, eMaterial.Q345D_T, 2, TubeSection.GetAs(0.6, 0.016) * P1.DistanceTo(P2) * 7.85);
        //                        idxofcarry.Add(i - 1);
        //                        WindBraceCount += 1;
        //                    }
        //                    else
