...
namespace AnsysInterface
{
    public class OsisExt
    {
        ...
        private void WriteSMLSection(ref StreamWriter sw)
        {
            ...
            sw.WriteLine("#实腹圆形截面,  1,  1 ,  TB1400-25  ,  1400");
            sw.WriteLine("#实腹圆形截面,  2,  2 ,  TB1400-28  ,  1400");
            sw.WriteLine("#实腹圆形截面,  3,  3 ,  TB1400-32  ,  1400");
            sw.WriteLine("#实腹圆形截面,  4,  4 ,  TB1400-38  ,  1400");
            sw.WriteLine("#实腹圆形截面,  5,  5 ,  TB1400-40  ,  1400");
            sw.WriteLine("#环形截面, 21,  21 ,  TB900-20   , 900  , 20");
            sw.WriteLine("#环形截面, 22,  21 ,  TB800-16   , 800  , 16");
            sw.WriteLine("#环形截面, 23,  21 ,  TB600-12   , 600  , 12");
            sw.WriteLine("#环形截面, 31,  21 ,  TB800-16   , 800  , 16");
            sw.WriteLine("#环形截面, 32,  21 ,  TB600-12   , 600  , 12");
            sw.WriteLine("#环形截面, 33,  21 ,  TB300-10   , 300  , 10");
            sw.WriteLine("#环形截面, 41,  21 ,  TB800-16   , 800  , 16");
            sw.WriteLine("#环形截面, 42,  21 ,  TB500-10   , 500  , 10");
            sw.WriteLine("#环形截面, 43,  21 ,  TB500-10   , 500  , 10");
            sw.WriteLine("#环形截面, 51,  21 ,  TB600-16   , 600  , 16");
            sw.WriteLine("#环形截面, 52,  21 ,  TB600-16   , 600  , 16");
            sw.WriteLine("#环形截面, 53,  21 ,  TB600-16   , 600  , 16");
            sw.WriteLine("#环形截面, 61,  21 ,  TB900-20   , 900  , 20");
            sw.WriteLine("#环形截面, 62,  21 ,  TB800-16   , 800  , 16");
            sw.WriteLine("#环形截面, 63,  21 ,  TB450-10   , 450  , 10");
            sw.WriteLine("#环形截面, 64,  21 ,  TB600-12   , 600  , 12");
        ...
        private void WrietSMLLoad(ref StreamWriter sw)
        {
            ...
            sw.WriteLine("// 定义荷载");
            sw.WriteLine("//-------------------自重荷载-------------------");
            sw.WriteLine("Acel,0,0,-9.806");
            sw.WriteLine("LG,1,AllElem-自重");
            sw.WriteLine("G0,1,AllElem");
            sw.WriteLine("LC,AllElem-自重,1.04");
            sw.WriteLine("LCLG,AllElem-自重,1,1");
            sw.WriteLine("//-------------------施工阶段-------------------");
            sw.WriteLine("St,CS1_单元");
            sw.WriteLine("StSel,CS1_单元");
            sw.WriteLine("ESel,None");
            sw.WriteLine("CMSel,A, AllElem, Elem");
            sw.WriteLine("CM,CS1_AllElem_单元激活,Elem");
            sw.WriteLine("StEA,,CS1_AllElem_单元激活");
            sw.WriteLine("StBA,,1");
            sw.WriteLine("StBA,,2");
            sw.WriteLine("StA,,Calc,AllElem-自重");
            sw.WriteLine("/Solu");
            sw.WriteLine("//Ctrl,Solve,Creep,1");
            sw.WriteLine("//Ctrl,Solve,Shrink,1");
            sw.WriteLine("Midas,1");
            sw.WriteLine("Actn,0");
            sw.WriteLine("Solve");
        }
